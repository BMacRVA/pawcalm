...
export default function AbsencePracticePage() {
    ...
    return (
      <div className="min-h-screen bg-[#FDFBF7]">
        ...
        <header className="px-6 pt-6 pb-4">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Absence Training</h1>
          <p className="text-gray-500 text-sm mt-1">Practice actually leaving {dog?.name}</p>
        </header>
